...
Showing that Cal Poly's Software Engineering students are not encouraged or assisted in meeting this standard in regards to software maintenance is the first building block to analyzing the Computer Science department's behavior according to Section 5.11 of the Software Engineering Code.  We ask the reader to please remain patient as this multi-layered argument is established.
...
%% Overall Analysis
\subsection{Overall Ethical Analysis}
